...
public:
	...
	virtual bool execute()
	{
		...
		if (err == EDS_ERR_OK)
		{
			...
			else if(strcmp(str, "Canon EOS-1D Mark IV") == 0)
			{
				dataSet.sizeJpegLarge.width = 4896;
				dataSet.sizeJpegLarge.height = 3264;
			}
			...
			else if(strcmp(str, "Canon EOS 7D") == 0)
			{
				dataSet.sizeJpegLarge.width = 5184;
				dataSet.sizeJpegLarge.height = 3456;
			}
			...
			else if(strcmp(str, "Canon EOS Kiss X3") == 0 || strcmp(str, "Canon EOS DIGITAL REBEL T1i") == 0 || strcmp(str, "Canon EOS 500D") == 0)
			{
				dataSet.sizeJpegLarge.width = 4752;
				dataSet.sizeJpegLarge.height = 3168;
			}
